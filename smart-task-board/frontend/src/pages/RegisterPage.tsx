      ...
      <div className="flex flex-1">
          ...
          <div className="relative">
            ...
            <div className="flex gap-12">
              <div>
                ...
                <p className="text-primary-200 text-xs font-semibold uppercase tracking-widest mt-0.5">No credit card</p>
              </div>
              <div>
                <p className="text-2xl font-extrabold text-white">14 days</p>
                <p className="text-primary-200 text-xs font-semibold uppercase tracking-widest mt-0.5">Pro trial included</p>
              </div>
            </div>
          </div>
          <div className="relative" />
        ...
        <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-20 bg-cream-200 dark:bg-neutral-950">
          <div className="w-full max-w-sm mx-auto">
            <h2 className="text-2xl font-bold text-neutral-800 dark:text-cream-100 mb-1">Create Account</h2>
            <p className="text-sm text-neutral-500 dark:text-neutral-400 dark:text-neutral-500 mb-8">Start your free workspace today.</p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                <label className="text-xs font-bold text-neutral-500 dark:text-neutral-400 dark:text-neutral-500 uppercase tracking-wider block mb-1.5">Full Name</label>
              ...
              <div>
                <label className="text-xs font-bold text-neutral-500 dark:text-neutral-400 dark:text-neutral-500 uppercase tracking-wider block mb-1.5">Password</label>
                <div className="relative">
