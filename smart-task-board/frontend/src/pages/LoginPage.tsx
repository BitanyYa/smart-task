          ...
          <div className="relative">
            ...
            <div className="flex gap-12">
              <div>
                ...
                <p className="text-blue-200 text-xs font-semibold uppercase tracking-widest mt-0.5">Uptime Reliability</p>
              </div>
              <div>
                <p className="text-2xl font-extrabold text-white">2.5M+</p>
                <p className="text-blue-200 text-xs font-semibold uppercase tracking-widest mt-0.5">Tasks Completed</p>
              </div>
            </div>
          </div>
